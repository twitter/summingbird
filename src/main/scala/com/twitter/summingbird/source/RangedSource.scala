...
// RangedSource extends ScaldingSource for use with date-aware
// sources. Many of these can be found in scalding-commons. . All
// sources that use this trait will automatically slop one hour behind
// and one hours forward to account for the delay in log grouping.
